...
public class WorkflowTraceService {
	...
	/*	根据流程实例获取流程节点，在Activiti中Execution和ProcessInstance都用于获取当前流程实例的相关信息。
	...
	/*	PropertyUtils提供了如下一组方法，它们接收simple、indexed和mapped属性的任意组合方法，支持任意层次的嵌套：
		...
		Object property = PropertyUtils.getProperty(execution, "activityId");//获取execution中的activitId属性值
		String activityId = "";//activityId和当前实例没有分支前的流程流程实例ID相同
		if (property != null) {
